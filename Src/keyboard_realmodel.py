...
XML_PATH = PROJECT_DIR / "Assest" / "psm_official" / "psm_control_dynamics.xml"
...
WORLD_LINEAR_SPEED = 0.035  # m/s
WRIST_SPEED = 0.75  # rad/s
JAW_SPEED = 0.9  # rad/s
...
MAX_QSTEP = np.array([0.010, 0.010, 0.0015])  # yaw, pitch, insertion per sim step
