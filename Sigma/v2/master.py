"""sigma.7 master-device wrapper reused by the v2 controller."""
...
class SigmaMaster:
    ...
    def button_mask(self) -> int:
        return int(self.device.button_mask())
    ...
    def _start_streaming(self) -> None:
        ...
        self._latest_state = None
        self._stream_thread = threading.Thread(target=self._stream_loop, name="sigma7-v2-loop", daemon=True)
